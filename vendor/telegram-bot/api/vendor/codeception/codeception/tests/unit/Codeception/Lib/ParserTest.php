...
class ParserTest extends \Codeception\TestCase\Test
{
    ...
    {
        $this->scenario = new Scenario(Stub::make('Codeception\TestCase\Cept'));
...
EOF;
    ...
    {
        $code = file_get_contents(Configuration::projectDir().'tests/cli/UnitCept.php');
    ...
    {
        $code = file_get_contents(Configuration::projectDir().'tests/web/FriendsCept.php');
