...
class ClassCodeGeneratorSpec extends ObjectBehavior
{
     ...
     * @param MethodNode   $method1
     * @param MethodNode   $method2
     * @param MethodNode   $method3
     * @param ArgumentNode $argument11
     * @param ArgumentNode $argument12
     * @param ArgumentNode $argument21
     * @param ArgumentNode $argument31
     */
