...
class GeneratePageObjectTest extends BaseCommandRunner
{
    ...
    public function testBasic()
    {
        ...
        $this->assertEquals(Configuration::supportDir().'Page/Login.php', $this->filename);
    ...
    public function testCreateForSuite()
    {
        ...
        $this->assertEquals(Configuration::supportDir().'Page/Shire/Login.php', $this->filename);
    ...
    public function testCreateInSubpath()
    {
        ...
        $this->assertEquals(Configuration::supportDir().'Page/User/View.php', $this->filename);
        $this->assertIsValidPhp($this->content);
    }
}
