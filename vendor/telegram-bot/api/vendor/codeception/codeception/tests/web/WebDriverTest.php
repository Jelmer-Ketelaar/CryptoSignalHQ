...
class WebDriverTest extends TestsForBrowsers
{
    ...
    public function testScreenshot()
    {
        ...
        @unlink(Configuration::outputDir().'testshot.png');
        $testName="debugTest";

        $this->module->makeScreenshot($testName);
        $this->assertFileExists(Configuration::outputDir().'debug/'.$testName.'.png');
        @unlink(Configuration::outputDir().'debug/'.$testName.'.png');

        $this->module->_saveScreenshot(Configuration::outputDir().'testshot.png');
        $this->assertFileExists(Configuration::outputDir().'testshot.png');
        @unlink(Configuration::outputDir().'testshot.png');
    }
    ...
    public function testWebDriverByLocators()
    {
        ...
        $this->module->seeElement(WebDriverBy::xpath(Locator::tabIndex(4)));
    ...
    public function testCreateCeptScreenshotFail()
    {
        ...
        $cept = (new Cept())->configName('loginCept.php');
