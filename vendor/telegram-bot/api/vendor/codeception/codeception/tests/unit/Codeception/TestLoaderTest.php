...
class TestLoaderTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $this->testLoader = new TestLoader(Configuration::dataDir());
    }
    ...
    public function testLoadAllTests()
    {
        ...
        $this->testLoader = new TestLoader(codecept_data_dir().'claypit/tests');
    ...
    protected function getTestNames($tests)
    {
        ...
        foreach ($tests as $test) {
            if ($test instanceof PHPUnit_Framework_TestCase) {
                $testNames[] = TestCase::getTestSignature($test);
            }
        }
        return $testNames;
    }
