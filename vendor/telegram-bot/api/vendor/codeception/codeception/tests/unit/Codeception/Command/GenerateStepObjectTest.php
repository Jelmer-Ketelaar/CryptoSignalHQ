...
class GenerateStepObjectTest extends BaseCommandRunner {
    ...
    public function testBasic()
    {
        ...
        $this->assertEquals(Configuration::supportDir().'Step/Shire/Login.php', $generated['filename']);
    ...
    public function testNamespace()
    {
     ...
     public function testCreateInSubpath()
     {
         ...
         $generated = $this->log[0];
         $this->assertEquals(Configuration::supportDir().'Step/Shire/User/Login.php', $generated['filename']);
         $this->assertIsValidPhp($this->content);
     }
