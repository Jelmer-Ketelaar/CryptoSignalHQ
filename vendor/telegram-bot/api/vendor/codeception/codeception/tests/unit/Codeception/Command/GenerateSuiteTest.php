...
class GenerateSuiteTest extends BaseCommandRunner {
    ...
    public function testBasic()
    {
        ...
        $this->assertEquals(Configuration::projectDir().'tests/shire.suite.yml',$this->filename);
        $conf = Yaml::parse($this->content);
        ...
        $helper = $this->log[1];
        $this->assertEquals(Configuration::supportDir().'Helper/Hobbit.php',$helper['filename']);
        ...
        $this->assertEquals(Configuration::projectDir().'tests/shire/_bootstrap.php',$bootstrap['filename']);
    }
