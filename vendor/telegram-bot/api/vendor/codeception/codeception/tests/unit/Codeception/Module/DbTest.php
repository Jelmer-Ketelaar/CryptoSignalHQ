...
class DbTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        self::$module = new Db(make_container());
        self::$module->_setConfig(self::$config);
        self::$module->_initialize();

        $sqlite = self::$module->driver;
        $sqlite->cleanup();
        $sql = file_get_contents(Configuration::dataDir() . '/dumps/sqlite.sql');
    ...
    {
        self::$module->_before(Stub::make('\Codeception\TestCase'));
        ...
        self::$module->_after(Stub::make('\Codeception\TestCase'));
    ...
    {
        $testCase1 = Stub::make('\Codeception\TestCase');
        $testCase2 = Stub::make('\Codeception\TestCase');
