...
use Codeception\Step\Ignore;
use Codeception\Step\Incomplete;
...
class Scenario
{
     ...
     * @param TestCase $test
     */
    public function __construct(TestCase $test, $currents = [])
    {
        $this->test = $test;
    ...
    {
        $this->blocker = new Skip($reason, []);
    }

    public function incomplete($reason = "")
    {
        $this->blocker = new Incomplete($reason, []);
    }

    protected function ignore()
    {
        $this->blocker = new Ignore;
    }
    ...
    {
        Notification::deprecate("Scenario is never preloaded. Please remove \$scenario->preload() call.", $this->getFeature());
        return false;
    }

    public function running()
    {
        Notification::deprecate("Scenario is always running. Please remove \$scenario->running() call.", $this->getFeature());
        return true;
    }
