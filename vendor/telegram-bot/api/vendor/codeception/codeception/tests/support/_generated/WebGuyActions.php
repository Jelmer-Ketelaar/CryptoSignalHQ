...
trait WebGuyActions
{
     ...
     * @see WebDriver::debugWebDriverLogs
     */
     ...
     * @param $text
     * Conditional Assertion: Test won't be stopped on fail
     * @see WebDriver::dontSeeInPageSource
     */
     ...
     * @param $uri
     * Conditional Assertion: Test won't be stopped on fail
     * @see WebDriver::seeCurrentUrlEquals
     */
     ...
     * @param $uri
     * Conditional Assertion: Test won't be stopped on fail
     * @see WebDriver::seeCurrentUrlMatches
     */
     ...
     * @param $uri
     * Conditional Assertion: Test won't be stopped on fail
     * @see WebDriver::dontSeeInCurrentUrl
     */
     ...
     * @param $uri
     * Conditional Assertion: Test won't be stopped on fail
     * @see WebDriver::dontSeeCurrentUrlEquals
     */
     ...
     * @param $uri
     * Conditional Assertion: Test won't be stopped on fail
     * @see WebDriver::dontSeeCurrentUrlMatches
     */
     ...
     *
     * @return mixed
     * @see WebDriver::grabFromCurrentUrl
     */
     ...
     * @param $checkbox
     * Conditional Assertion: Test won't be stopped on fail
     * @see WebDriver::seeCheckboxIsChecked
     */
     ...
     * @param $checkbox
     * Conditional Assertion: Test won't be stopped on fail
     * @see WebDriver::dontSeeCheckboxIsChecked
     */
     ...
     * @param $params
     * Conditional Assertion: Test won't be stopped on fail
     * @see WebDriver::dontSeeInFormFields
     */
     ...
     *
     * @return mixed
     * @see WebDriver::grabAttributeFrom
     */
     ...
     * @param $selector
     * Conditional Assertion: Test won't be stopped on fail
     * @see WebDriver::dontSeeElementInDOM
     */
     ...
     * Conditional Assertion: Test won't be stopped on fail
     * @see WebDriver::seeNumberOfElements
     */
     ...
     *
     * Conditional Assertion: Test won't be stopped on fail
     * @see WebDriver::seeNumberOfElementsInDOM
     */
     ...
     * @return mixed
     * Conditional Assertion: Test won't be stopped on fail
     * @see WebDriver::seeOptionIsSelected
     */
     ...
     * @return mixed
     * Conditional Assertion: Test won't be stopped on fail
     * @see WebDriver::dontSeeOptionIsSelected
     */
     ...
     * @see WebDriver::waitForElementChange
     */
     ...
     * @param int $timeout seconds
     * @throws Exception
     * @see WebDriver::waitForElementVisible
     */
     ...
     * @param int $timeout seconds
     * @throws Exception
     * @see WebDriver::waitForElementNotVisible
     */
     ...
     * @see WebDriver::executeInSelenium
     */
     ...
     * @param $cssOrXPath
     * @throws ElementNotFound
     * @see WebDriver::clickWithRightButton
     */
     ...
     *
     * @param string $name
     * @see WebDriver::saveSessionSnapshot
     */
     ...
     * @param string $name
     * @return bool
     * @see WebDriver::loadSessionSnapshot
     */
