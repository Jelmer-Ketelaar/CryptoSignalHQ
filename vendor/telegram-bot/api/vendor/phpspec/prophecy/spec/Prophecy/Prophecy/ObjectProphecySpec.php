...
class ObjectProphecySpec extends ObjectBehavior
{
    ...
    /**
     * @param MethodProphecy    $method1
     * @param MethodProphecy    $method2
     ...
     * @param ArgumentsWildcard $argumentsWildcard
     */
    ...
    /**
     * @param MethodProphecy    $methodProphecy1
     * @param MethodProphecy    $methodProphecy2
     * @param ArgumentsWildcard $argumentsWildcard1
     * @param ArgumentsWildcard $argumentsWildcard2
     */
     ...
     * @param ProphecySubjectInterface $reflection
     */
